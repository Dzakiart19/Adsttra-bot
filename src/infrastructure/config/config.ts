...
const ConfigSchema = z.object({
  ...
  DEFAULT_URL: z.preprocess((val) => process.env.URL || val, z.string().url()),
  ...
  // Strip protokol http:// / https:// jika pengguna tidak sengaja menyertakannya
  PROXY_URL: z.string().optional().transform(v => v ? v.replace(/^https?:\/\//i, '') : v),
